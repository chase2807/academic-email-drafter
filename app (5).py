...
def generate_email_draft(prompt, intent, recipient_name="", paper_details="", other_info=""):
    """
    Generates a draft email based on intent and user inputs using the OpenAI API.
    """
        ...
        with st.spinner("🤖 Drafting your email..."):
            ...
            if OPENAI_API_KEY:
                ...
                st.session_state.draft = draft
                 ...
                 st.session_state.error_message = "⚠️ OpenAI API Key not set. Please configure it on your deployment platform."
